...
import bitcoin1 from '../../img/bitcoin1.svg';
import bitcoin2 from '../../img/bitcoin2.svg';
...
const Homepage = () => {
    return(
        <div className={style.homepage}>
            <img src={bitcoin} alt="Bitcoin Vector Illustration" className={style.bitcoin}/>
            <img src={bitcoin1} alt="Bitcoin Vector Illustration" className={style.bitcoin1}/>
            <img src={bitcoin2} alt="Bitcoin Vector Illustration" className={style.bitcoin2}/>
            <div className={style.page}>
                <div className={style.text}>
                    <h1><span className={style.emph}>Crypto</span> Report</h1>
                    <p>Rimani aggiornato sui dati delle più importante criptovalute</p>
                </div>
                <Link to="/data">
                    <button className={style.button}>Vai ai dati</button>
                </Link>
            </div>
            <div className={style.background}>
                <div className={style.customShapeDividerBottom1604909410}>
